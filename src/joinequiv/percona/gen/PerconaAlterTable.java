...
public class PerconaAlterTable {
    ...
    public PerconaAlterTable(PerconaSchema newSchema) {
        this.schema = newSchema;
    }

    public static SQLQueryAdapter create(PerconaGlobalState globalState) {
        return new PerconaAlterTable(globalState.getSchema()).create();
    }
    ...
    private enum Action {
        ...
        CHECKSUM, //
        COMPRESSION, //
        DISABLE_ENABLE_KEYS("Data truncated for functional index"), /* ignore due to http://bugs.Percona.com/?id=96295 */
        DROP_COLUMN("Cannot drop column", "ALGORITHM=INPLACE is not supported.", "ALGORITHM=INSTANT is not supported.",
                ...
                "A primary key index cannot be invisible" /*
                                                           ...
                                                           * https://bugs.Percona.com/bug.php?id=95897
                                                           */,
    ...
    private SQLQueryAdapter create() {
        ...
        if (!table.hasPrimaryKey() || PerconaBugs.bug95894) {
