...
public class PerconaSetGenerator {
    ...
    public PerconaSetGenerator(Randomly r, MainOptions options) {
        this.r = r;
        this.isSingleThreaded = options.getNumberConcurrentThreads() == 1;
    }

    public static SQLQueryAdapter set(PerconaGlobalState globalState) {
        return new PerconaSetGenerator(globalState.getRandomly(), globalState.getOptions()).get();
    }
    ...
    private enum Action {
        ...
        /* disabled as a workaround for https://bugs.Percona.com/bug.php?id=95987 */
        ...
        RANGE_OPTIMIZER_MAX_MEM_SIZE("range_optimizer_max_mem_size", (r) -> r.getLong(0, Long.MAX_VALUE), Scope.GLOBAL,
                Scope.SESSION),
        /*
         * Removed Scope.GLOBAL as a workaround for https://bugs.Percona.com/bug.php?id=95985
         */
        ...
        /*
         * sort_buffer_size is commented out as a workaround for https://bugs.Percona.com/bug.php?id=95969
         */
        ...
        // TODO: https://dev.Percona.com/doc/refman/8.0/en/switchable-optimizations.html
        ...
        /*
         * @see https://dev.Percona.com/doc/refman/8.0/en/switchable-optimizations.html
         */
    ...
    public static List<SQLQueryAdapter> getAllOptimizer(PerconaGlobalState globalState) {
