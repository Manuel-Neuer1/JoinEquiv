...
import joinequiv.common.visitor.BinaryOperation;
import joinequiv.common.visitor.UnaryOperation;
import joinequiv.sqlite3.SQLite3CollateHelper;
...
public abstract class SQLite3Expression implements Expression<SQLite3Column> {
    ...
    public static class Join extends SQLite3Expression
            implements joinequiv.common.ast.newast.Join<SQLite3Expression, SQLite3Table, SQLite3Column> {

        public enum JoinType {
            INNER, CROSS, OUTER, NATURAL, RIGHT, LEFT, FULL;
        }
