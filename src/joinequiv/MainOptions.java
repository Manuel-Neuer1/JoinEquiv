...
import joinequiv.Randomly.StringGenerationStrategy;
...
public class MainOptions {
    ...
    private int totalNumberTries = 10000; // NOPMD
    ...
    private String userName = "joinequiv"; // NOPMD

    @Parameter(names = "--password", description = "The password used to log into the DBMS")
    private String password = "joinequiv"; // NOPMD
